...
// Fetch lamb products only
$query = "SELECT product_id, name, price_description, image FROM products WHERE category = 'lamb'";
...
<html>
<head>
    <title>The Meat Room - Lamb</title>
...
<body>
    ...
    <div>
        <div class="product-section">
            <h1>LAMB PRODUCTS</h1>
            <table style="padding-bottom:15px;padding-top:40px;padding-bottom:70px;" id="lamb-products">
                <?php
                $count = 0;
